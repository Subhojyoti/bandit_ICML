\begin{figure}[!tbp]
    ...
    \subfigure[0.25\textwidth][Experiment $1$: $20$ Bernoulli-distributed arms with $r_{i_{{i}\neq {*}}}=0.07$ and $r^{*}=0.1$.]
    {
        ...
        %clip mode=individual,grid,grid style={gray!30},
      	...
      	% UCB
		\addplot table{results/NewExpt/Expt1/UCB_Vcomp_subsampled1.txt};
		\addplot table{results/NewExpt/Expt1/DMEDcomp_subsampled1.txt};
		\addplot table{results/NewExpt/Expt1/KLUCBcomp_subsampled1.txt};
		\addplot table{results/NewExpt/Expt1/MOSScomp_subsampled1.txt};
		\addplot table{results/NewExpt/Expt1/UCB1comp_subsampled1.txt};
		\addplot table{results/NewExpt/Expt1/TScomp_subsampled1.txt};
		\addplot table{results/NewExpt/Expt1/EclUCB01comp_subsampled1.txt};
      	\legend{UCB-V,DMED,KL-UCB,MOSS,UCB1,TS,EClusUCB}      	
      	\end{axis}
      	\end{tikzpicture}
  		\label{fig:1}
    }
    ...
    \subfigure[0.25\textwidth][Experiment $2$: $100$ Gaussian-distributed arms with $r_{i_{{i}\neq {*}:1-33}}=0.01$, $r_{i_{{i}\neq {*}:34-99}}=0.06$ and $r^{*}_{i=100}=0.1$. ]
    {
        ...
        %clip mode=individual,grid,grid style={gray!30},
  		...
  		legend style={at={(0.5,1.5)},anchor=north, legend columns=3} ]
      	% UCB
        \addplot table{results/NewExpt/Expt2/UCB1comp_subsampled1.txt};
		\addplot table{results/NewExpt/Expt2/clucb_p_10_comp_subsampled1.txt};
		\addplot table{results/NewExpt/Expt2/Med_Elimcomp_subsampled1.txt};
		\addplot table{results/NewExpt/Expt2/AclUCB01_comp_subsampled1.txt};
		\addplot table{results/NewExpt/Expt2/MOSScomp_subsampled1.txt};
		\addplot table{results/NewExpt/Expt2/EclUCB02_comp_subsampled1.txt};
		\addplot table{results/NewExpt/Expt2/UCB_Improvedcomp_subsampled1.txt};
