...
\begin{table}
\caption{Comparison of different algorithms against EClusUCB. The \checkmark indicates better performance (or bound). }
\label{tab:comp-bds}
\begin{center}
...
\midrule
UCB1        &\xmark &\xmark &\xmark &\xmark \\\midrule
UCB-Imp 		&\xmark &\xmark &\xmark &\xmark \\\midrule
MOSS	     	&\xmark &\checkmark &\xmark &\xmark \\\midrule
OCUCB     	&\checkmark &\checkmark &\xmark &\xmark \\\midrule
