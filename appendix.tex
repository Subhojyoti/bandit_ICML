...
\begin{figure}[!tbp]
    ...
    &
    \subfigure[0.32\textwidth][Experiment $4$: Cumulative regret for ClusUCB variants: $1,3,5,10,15,25$ correspond to number $p$ of clusters]
    {
    		\pgfplotsset{
		tick label style={font=\Huge},
		label style={font=\Huge},
...
%      	\legend{ClusUCB(1),ClusUCB(3),ClusUCB(5),ClusUCB(10),ClusUCB(15),ClusUCB(25)} 
    ...
    \caption{Cumulative regret for ClusUCB variants}
\end{figure}
